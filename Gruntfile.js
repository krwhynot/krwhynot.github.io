// Generated on 2020-03-24 using generator-web-data-connector 2.0.0-beta.2
    ...
    'gh-pages': {
      ...
      travisDeploy: {
        options: {
          ...
          repo: 'https://' + process.env.GH_TOKEN + '@github.com/repo-owner/my-web-data-connector.git',
